...
const MessageContainer = () => {
  ...
  const checkIfImage= (filePath)=>{
    const imageRegex=/\.(jpg|jpeg|png|gif|bmp|tiff|svg|tif|ico|webp|heic|heif)$/i;
           ...
           <Avatar className='h-8 w-8  rounded-full overflow-hidden'>
                  {
                    ...
                    <AvatarFallback className={`uppercase h-8 w-8 text-lg  flex items-center justify-center rounded-full ${getColor(message.sender.color
                      ...
                      )}`}>
                      {
                        ...
                        message.sender.firstName.split("").shift() : message.sender.email.split("").shift()
                      }
  ...
  return (
    <div className='flex-1 overflow-y-auto scrollbar-hidden  p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:[20vw]'>
      {renderMessages()}
      <div ref={scrollRef}>
        {
